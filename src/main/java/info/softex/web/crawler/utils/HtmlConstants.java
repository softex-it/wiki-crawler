 ...
 * 
 * @modified modified 2.0,	01/21/2015
 * 
...
public class HtmlConstants {
	...
	public static final String BROWSER_CL_RED = "#FF0000";
	
	public static final String BROWSER_CL_GREEN = "#008000";
	
	public static final String BROWSER_CL_BLUE = "#0000FF";
	...
	public final static String ATT_HEIGHT = "height";
	public final static String ATT_STYLE = "style";
	
	public final static String STL_FLOAT_KEY = "float";
